...
var base_url = protocol + '://web.vokino.tv/'
...
httpGetAsync(
    ...
    function(html) {
        ...
        if (
            ...
            scripts_array.unshift({
                url: 'http://vokino.github.io/js/webOSTV.js'
            })
        }
    ...
    function() {
        document.getElementsByTagName('body')[0].innerHTML =
            '<div style="height: 100vh; display: flex; align-items: center; justify-content: center;"><img src="http://web.vokino.tv/img/icons/tv-broken.svg" style="width: 18%" /></div>'
    }
)
